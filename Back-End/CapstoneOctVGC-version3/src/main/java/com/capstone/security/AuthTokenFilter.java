 ...
 * != null && jwtUtils.validateJwtToken(jwt)) { String email =
 * jwtUtils.getEmailFromJwtToken(jwt); UserDetails userDetails =
 ...
 * request.getHeader("Authorization"); if (StringUtils.hasText(headerAuth) &&
 * headerAuth.startsWith("Bearer ")) { return headerAuth.substring(7,
 * headerAuth.length()); } return null; }
 * 
 * }
 */
